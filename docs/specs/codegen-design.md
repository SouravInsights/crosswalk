...
└─────────────┘     └──────────────┘     └───────────────┘     └──────────────┘
      ...
      ▼
 OpenAPI / GraphQL SDL / Zod & tRPC routers /
...
interface CandidateTool {
  ...
  sourceLocation: {
    kind: "openapi" | "trpc" | "zod" | "prisma" | "graphql" | "manual";
